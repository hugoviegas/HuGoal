    ...
    >
      ...
      <View style={{ flexDirection: "row", gap: 12 }}>
        {[
          ...
          {
            label: "Streak",
            value: String(profile?.streak_current ?? 0),
            icon: Trophy,
            color: colors.accent,
          },
          {
            label: "Best",
            value: String(profile?.streak_longest ?? 0),
            icon: CalendarDays,
            color: colors.foreground,
          },
        ].map((item) => {
      ...
      <GlassCard style={{ padding: 16 }}>
        ...
        <View style={{ gap: 12 }}>
          <DetailRow
            label="Birth date"
            value={formatBirthDate(profile?.birth_date) || "Not set"}
          />
          <DetailRow
            label="Age"
          ...
          <DetailRow
            label="Sex"
            value={profile?.sex ? profile.sex : "Not set"}
          />
          <DetailRow
            label="Goal"
            value={profile?.goal ? profile.goal : "Not set"}
          />
          <DetailRow
            label="Level"
            value={profile?.level ? profile.level : "Not set"}
          />
        </View>
      </GlassCard>
